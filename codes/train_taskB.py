...
from datasets_taskB import TOOL_COLS, Cholec80ToolDataset, Cholec80ToolDatasetWithOracleTime, Cholec80ToolDatasetWithTimePred
from models_taskB import ResNet18ToolDet, ResNet18ToolDetWithTimePred
...
def evaluate(model, loader, device, use_time: bool) -> dict:
    ...
    for batch in loader:
        if use_time:
            x, y, _, tfeat, _, tvalid, _vid = batch
